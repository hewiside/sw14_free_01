...
public class CanMoveTest6_castling_possible_WHITE extends
...
//	private Solo solo;
	...
	public CanMoveTest6_castling_possible_WHITE() {
	...
	public void testKing(){
		...
		setTrueTile(2, 0); // --> Castling possible
		setTrueTile(3, 0);
		setTrueTile(3, 1);
		setTrueTile(4, 1);
//		setTrueTile(5, 1); (our own pawn at (5,1))
		setTrueTile(5, 0);
		setTrueTile(6, 0); // --> Castling possible
